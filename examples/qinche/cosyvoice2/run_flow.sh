...
export WANDB_RUN_ID="flow-ft-${TIMESTAMP}"
...
MODEL_DIR=exp/cosyvoice2/flow_lr${LR}_batch${BATCH_SIZE}
TENSORBOARD_DIR=tensorboard/cosyvoice2/flow_lr${LR}_batch${BATCH_SIZE}

mkdir -p $MODEL_DIR
mkdir -p $TENSORBOARD_DIR

echo "========================================"
echo "CosyVoice2 Flow 模块微调 - 秦彻音色复刻"
echo "========================================"
echo "模型: $MODEL"
...
torchrun --nnodes=1 --nproc_per_node=1 \
    --rdzv_id=1001 --rdzv_backend="c10d" --rdzv_endpoint="localhost:1234" \
